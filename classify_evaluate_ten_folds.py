...
labeled_tweets = labeled_tweets[:100000]
...
for i in range(10):
	train_set = [(tweet_features(tweet), category) for (tweet, category) in labeled_tweets[0:i*10000]] + \
		[(tweet_features(tweet), category) for (tweet, category) in labeled_tweets[(i+1)*10000:100000]]
	test_set = [(tweet_features(tweet), category) for (tweet, category) in labeled_tweets[i*10000:(i+1)*10000]]
